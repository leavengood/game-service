...
// Show returns an endpoint that makes HTTP requests to the inventory service
// show server.
func (c *Client) Show() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "show", err)
		}
		return decodeResponse(resp)
	}
}

// Add returns an endpoint that makes HTTP requests to the inventory service
// add server.
func (c *Client) Add() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("inventory", "add", err)
		}
		return decodeResponse(resp)
	}
}

// Remove returns an endpoint that makes HTTP requests to the inventory service
// remove server.
