...
// List returns an endpoint that makes HTTP requests to the item service list
// server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("item", "list", err)
		}
		return decodeResponse(resp)
	}
}

// Show returns an endpoint that makes HTTP requests to the item service show
// server.
func (c *Client) Show() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("item", "show", err)
		}
		return decodeResponse(resp)
	}
}

// Add returns an endpoint that makes HTTP requests to the item service add
// server.
func (c *Client) Add() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("item", "add", err)
		}
		return decodeResponse(resp)
	}
}

// Update returns an endpoint that makes HTTP requests to the item service
// update server.
func (c *Client) Update() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("item", "update", err)
		}
		return decodeResponse(resp)
	}
}

// Remove returns an endpoint that makes HTTP requests to the item service
// remove server.
func (c *Client) Remove() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("item", "remove", err)
		}
		return decodeResponse(resp)
	}
}
